                                     ...
                                     <tr>
                                         <td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="padding-left: 10px;"><b>Mã du lịch: </b> '.$getdata[$count][6].'</td>
                                             </tr>
                                             <tr>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td style="padding-left: 10px;"><b>Nơi bắt đầu: </b>'.$getdata[$count][9].'</td>
                                                 </tr>
                                             </table>
                                             <td style="padding-left: 50px;">
                                                 <table> 
                                                     <tr>
                                                         ...
                                                         <td style="padding-left: 10px;"><b>Đến vị trí: </b> '.$getdata[$count][10].'</td>
                                                     </tr>
                                                     <tr>
                                                         <td> <i class="fas fa-chair"></i></td>
                                                         <td style="padding-left: 10px;"><b>Số lượng chỗ ngồi: </b> '.$getdata[$count][11].'</td>
                                                     </tr>
                                                 </table>
                                             </td>
                                         </td>
