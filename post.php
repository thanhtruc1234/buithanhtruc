    ...
    <div class="container">
            <div class="row">
                    ...
                    <div style="width: 100%;  background: #f8f8f8; border-radius: 3px; padding: 10px">
                       <?php if(isset($_SESSION['email'])) echo ' <form method="post">
                        ...
                        <script> CKEDITOR.replace(\'cmt\');</script>';
                            ...
                            echo '<span>Xin vui lòng <a href="./login.php">Đăng nhập</a>để bình luận!!</span>';
                        }
                       ?> 
                       
                        <hr>
                        <span style="font-size: 13px; margin-left:10px; position:relative; top:-20px;">Tất cả <?php echo $getCount ?> bình luận</span>
                ...
                <div class="col-3" style="background: #ccc;">
                    ...
                    <p style="font-size: 25px;">Những bài viết liên quan</p>
                    <hr>
