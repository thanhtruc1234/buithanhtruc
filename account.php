    ...
    <div class="row">
            ...
            <form  method="post" action="#" style="margin-top: 30px; margin-bottom: 30px; ">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"   id="name" value="<?php echo $getdata['name'] ?>" required="" placeholder="Bui Thanh Truc" name="name">
                </div>
                <div class="form-group">
                    <label for="" style="color: #f2f2f2;">Email</label>
                    <input type="text" class="form-control" id="email" value="<?php echo $getdata['email'] ?>" required="" placeholder="buithanhtruc12a8@gmail.com" name="email">
                </div>
            <div id="emaill" style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">Email không hợp lệ.</div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phonenumber"  value="<?php echo $getdata['phonenumber'] ?>" required="" placeholder="0372183232" name="phonenumber">
                </div>
                     <div id="sdt" style="display:none;background: #f5c6cb;padding: 3px;border-left: #e00 solid 5px;">Số điện thoại không hợp lệ.</div>
                <div class="form-group">
                    <label for="" style="color: #f2f2f2;">Địa chỉ</label>
                    <input type="text" class="form-control" id="address"  value="<?php echo $getdata['address'] ?>"  required=""  placeholder="Cát Hanh - Phù Cát - Bình Định" name="address">
                  </div>
            ...
            <div class="form-group">
                    ...
                    <input type="password" class="form-control"  id="password" required="" placeholder="Nhập vào mật khẩu" name="oldpassword">
                </div>

             <div class="form-group">
                    <label for="" style="color: #f2f2f2;">Một mật khẩu mới</label>
                    <input type="password" class="form-control"  id="password" required="" placeholder="Nhập vào mật khẩu" name="new1password">
                </div>
                <div class="form-group">
                    <label for="" style="color: #f2f2f2;">Xác nhận mật khẩu</label>
                    <input type="password" class="form-control"  id="password2" required="" placeholder="Nhập xác nhận mật khẩu" name="new2password">
                </div>
